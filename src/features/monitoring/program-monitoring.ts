...
export type ProgramMonitoring = {active_participants:number;team_count:number;proposal_submitted:number;deliverable_submitted_teams:number;deliverable_count:number;reports_awaiting_review:number;teams:MonitoringTeam[];rounds:MonitoringRound[]}
