...
import { CalendarDays, FileStack, LayoutDashboard, Layers3, LogOut, Megaphone, Users, UsersRound } from 'lucide-react'
  ...
  return <div className="workspace">
    <aside className="workspace-sidebar">
      ...
      <nav aria-label="관리 메뉴">
        ...
        {profile?.role === 'professor' && <><NavLink to="/cohorts"><Layers3 size={18} aria-hidden="true" /> 프로그램 관리</NavLink><NavLink to="/participants"><Users size={18} aria-hidden="true" /> 참가자 관리</NavLink><NavLink to="/deliverables"><FileStack size={18} aria-hidden="true" /> 산출물 현황</NavLink></>}
      </nav>
