...
for (const path of ['/auth/v1/settings', '/rest/v1/AD_profiles?select=id&limit=0', '/rest/v1/AD_cohorts?select=id&limit=0', '/rest/v1/AD_participants?select=id&limit=0', '/rest/v1/AD_schedules?select=id&limit=0', '/rest/v1/AD_teams?select=id&limit=0', '/rest/v1/AD_team_members?select=team_id&limit=0', '/rest/v1/AD_proposals?select=team_id&limit=0', '/rest/v1/rpc/AD_team_workspace?p_cohort=00000000-0000-0000-0000-000000000000']) {
  try {
