...
for (const path of ['/auth/v1/settings', '/rest/v1/AD_profiles?select=id&limit=0', '/rest/v1/AD_cohorts?select=id&limit=0', '/rest/v1/AD_participants?select=id&limit=0', '/rest/v1/AD_schedules?select=id&limit=0', '/rest/v1/AD_announcements?select=id&limit=0', '/rest/v1/AD_login_activities?select=id&limit=0', '/rest/v1/AD_gpu_reservations?select=id&limit=0', '/rest/v1/AD_teams?select=id&limit=0', '/rest/v1/AD_team_members?select=team_id&limit=0', '/rest/v1/AD_proposals?select=team_id&limit=0', '/rest/v1/AD_reports?select=id&limit=0', '/rest/v1/AD_comments?select=id&limit=0', '/rest/v1/AD_deliverables?select=id&limit=0', '/rest/v1/rpc/AD_team_workspace?p_cohort=00000000-0000-0000-0000-000000000000', '/rest/v1/rpc/AD_program_monitoring?p_cohort=00000000-0000-0000-0000-000000000000', '/rest/v1/rpc/AD_program_deliverables?p_cohort=00000000-0000-0000-0000-000000000000', '/rest/v1/rpc/AD_dashboard_participant_counts', '/rest/v1/rpc/AD_team_full_report?p_team=00000000-0000-0000-0000-000000000000']) {
  try {
